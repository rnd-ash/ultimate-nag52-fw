...
#define FOR_LIST(DO) \
    ...
    /* HFM ENGINE DATA */ \
    DO(MAP_NAME_HFM_ENGINE_TORQUE, "HFM_ENGINE_TORQUE_MAP")\
    DO(MAP_NAME_HFM_ENGINE_MASS_AIR_FLOW, "HFM_ENGINE_MAF_MAP")\
    DO(MAP_NAME_HFM_ENGINE_MAX_MASS_AIR_FLOW, "HFM_ENGINE_MAX_MAF_MAP")\
