...
#define FOR_LIST(DO) \
    ...
    DO(MAP_NAME_WORKING_MPC , "WORK_MPC")\
    DO(MAP_NAME_FILL_TIME_SMALL, "FILL_T_SMALL")\
    DO(MAP_NAME_FILL_TIME_LARGE, "FILL_T_LARGE")\
    DO(MAP_NAME_TCC_PWM , "TCC_PWM")\
    DO(MAP_NAME_PCS_BROWN , "PCS_BROWN")\
    DO(MAP_NAME_PCS_BLUE , "PCS_BLUE")\
    DO(MAP_NAME_FILL_PRESSURE , "FILL_PRESS_1")\
    ...
    DO(TCC_LEARN_LOCK_MAP,"TCC_LOCK")\
    ...
    /* SUBSYSTEM SETTINGS */ \
    DO(TCC_SETTINGS, "TCC_A3")\
    DO(SOL_SETTINGS, "SOL_A0")\
    DO(SBS_SETTINGS, "SBS_A2")\
