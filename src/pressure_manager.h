...
#define SHIFT_PHASE_HOLD_1 0
#define SHIFT_PHASE_HOLD_2 1
#define SHIFT_PHASE_HOLD_3 2
#define SHIFT_PHASE_TORQUE 3
#define SHIFT_PHASE_OVERLAP 4
#define SHIFT_PHASE_MAX_P 5

#define HOLD_1_RAMP_TIME 100
#define HOLD_3_RAMP_TIME 60
#define HOLD_3_HOLD_TIME 100
...
public:
     ...
     */
    uint16_t get_p_solenoid_pwm_percent(uint16_t request_mbar);
