#ifndef __EGS_BASIC_CAN_H_
#define __EGS_BASIC_CAN_H_
...
class EgsBasicCan: public AbstractCan {
    public:
        explicit EgsBasicCan(const char* name, uint8_t tx_time_ms);
