...
typedef union {
    ...
    bool get_FuelPress_Rq_NA() { return (bool)(raw >> 47 & 0x1); }
    ...
    bool get_FuelPress_IncHydrRst() { return (bool)(raw >> 46 & 0x1); }
    ...
    FSCM_STAT_FuelPressSens_Stat_V2 get_FuelPressSens_Stat_V2() { return (FSCM_STAT_FuelPressSens_Stat_V2)(raw >> 42 & 0x7); }
    ...
    FSCM_STAT_FSCM_Stat_AMG get_FSCM_Stat_AMG() { return (FSCM_STAT_FSCM_Stat_AMG)(raw >> 16 & 0x7); }
    ...
    bool get_ESIM_Cntct_Stat_EngShutOff() { return (bool)(raw >> 15 & 0x1); }
...
typedef union {
    ...
    NM_FSCM_NM_Ud_Launch get_NM_Ud_Launch() { return (NM_FSCM_NM_Ud_Launch)(raw >> 40 & 0x3f); }
    ...
    NM_FSCM_NM_Ud_Srv get_NM_Ud_Srv() { return (NM_FSCM_NM_Ud_Srv)(raw >> 32 & 0xff); }
    ...
    NM_FSCM_Nw_Id get_Nw_Id() { return (NM_FSCM_Nw_Id)(raw >> 0 & 0xff); }
...
class ECU_FSCM {
	public:
        ...
        /** Sets data in pointer to FSCM_STAT
          ...
          */
        bool get_FSCM_STAT(uint64_t now, uint64_t max_expire_time, FSCM_STAT* dest) {
        ...
        /** Sets data in pointer to NM_FSCM
          ...
          * If the function returns true, then the pointer to 'dest' has been updated with the new CAN data
          */
        bool get_NM_FSCM(uint64_t now, uint64_t max_expire_time, NM_FSCM* dest) {
