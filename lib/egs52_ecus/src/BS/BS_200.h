...
typedef union {
    ...
    void set_BS_200H_BLS(uint8_t value){ raw = (raw & 0xfffcffffffffffff) | ((uint64_t)value & 0x3) << 48; }
    ...
    void set_BS_200H_DRTGVL(uint8_t value){ raw = (raw & 0xffff3fffffffffff) | ((uint64_t)value & 0x3) << 46; }
    ...
    void set_BS_200H_DRTGVR(uint8_t value){ raw = (raw & 0xffffffff3fffffff) | ((uint64_t)value & 0x3) << 30; }
    ...
    void set_BS_200H_DRTGTM(uint8_t value){ raw = (raw & 0xffffffffffff3fff) | ((uint64_t)value & 0x3) << 14; }
