...
class ECU_GS {
	public:
        ...
        /** Sets data in pointer to GS_218
          ...
          */
        bool get_GS_218(const uint32_t now, const uint32_t max_expire_time, GS_218_EGS52* dest) const {
            bool ret = false;
        ...
        /** Sets data in pointer to GS_338
          ...
          * If the function returns true, then the pointer to 'dest' has been updated with the new CAN data
          */
        bool get_GS_338(const uint32_t now, const uint32_t max_expire_time, GS_338_EGS52* dest) const {
            bool ret = false;
        ...
        /** Sets data in pointer to GS_418
          ...
          * If the function returns true, then the pointer to 'dest' has been updated with the new CAN data
          */
        bool get_GS_418(const uint32_t now, const uint32_t max_expire_time, GS_418_EGS52* dest) const {
            bool ret = false;
