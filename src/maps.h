...
extern const float SHIFT_P_OVERLAP_AREA_MAP[SHIFT_VALVE_MAP_SIZE];
extern const float MODULATING_P_OVERLAP_AREA_MAP[SHIFT_VALVE_MAP_SIZE];
extern const float SHIFT_CIRCUIT_FACTOR_MAP[SHIFT_VALVE_MAP_SIZE];
