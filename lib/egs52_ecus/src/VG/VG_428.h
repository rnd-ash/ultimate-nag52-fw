...
typedef union {
    ...
    void set_VG_428H_VG_GANG(uint8_t value){ raw = (raw & 0xf8ffffffffffffff) | ((uint64_t)value & 0x7) << 56; }
    ...
    // Sets VG
    void set_VG_428H_ANFN_VG(uint8_t value){ raw = (raw & 0xfffcffffffffffff) | ((uint64_t)value & 0x3) << 48; }
    // Gets VG
