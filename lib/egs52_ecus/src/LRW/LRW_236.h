...
typedef union {
    ...
    void set_LRW_236H_LRWS_ST(uint8_t value){ raw = (raw & 0xfffffffffcffffff) | ((uint64_t)value & 0x3) << 24; }
    ...
    void set_LRW_236H_LRWS_ID(uint8_t value){ raw = (raw & 0xfffffffff3ffffff) | ((uint64_t)value & 0x3) << 26; }
