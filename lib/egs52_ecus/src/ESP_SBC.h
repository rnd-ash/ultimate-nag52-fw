...
typedef union {
    ...
    bool get_BRE_KL() { return (bool)(raw >> 63 & 0x1); }
    ...
    bool get_BAS_KL() { return (bool)(raw >> 62 & 0x1); }
    ...
    bool get_ESP_INFO_BL() { return (bool)(raw >> 61 & 0x1); }
    ...
    bool get_ESP_INFO_DL() { return (bool)(raw >> 60 & 0x1); }
    ...
    bool get_ESP_KL() { return (bool)(raw >> 59 & 0x1); }
    ...
    bool get_ABS_KL() { return (bool)(raw >> 58 & 0x1); }
    ...
    bool get_BBV_KL() { return (bool)(raw >> 56 & 0x1); }
    ...
    bool get_BLS_UNT() { return (bool)(raw >> 55 & 0x1); }
    ...
    BS_200h_BLS get_BLS() { return (BS_200h_BLS)(raw >> 48 & 0x3); }
...
typedef union {
    ...
    bool get_DDYN_UNT() { return (bool)(raw >> 55 & 0x1); }
    ...
    bool get_TM_AUS() { return (bool)(raw >> 52 & 0x1); }
    ...
    bool get_BRE_AKT_ESP() { return (bool)(raw >> 47 & 0x1); }
...
typedef union {
    ...
    bool get_BAS_AKT() { return (bool)(raw >> 61 & 0x1); }
    ...
    bool get_VOLLBRE() { return (bool)(raw >> 60 & 0x1); }
        
    /** Sets Enable Art */
    void set_ART_E(bool value){ raw = (raw & 0xf7ffffffffffffff) | ((uint64_t)value & 0x1) << 59; }

    /** Gets Enable Art */
    bool get_ART_E() { return (bool)(raw >> 59 & 0x1); }
    ...
    bool get_ESP_GIER_AKT() { return (bool)(raw >> 58 & 0x1); }
    ...
    bool get_LWS_INI_OK() { return (bool)(raw >> 57 & 0x1); }
    ...
    bool get_AMR_AKT_ESP() { return (bool)(raw >> 53 & 0x1); }
    ...
    bool get_SFB_PA() { return (bool)(raw >> 50 & 0x1); }
...
typedef union {
    ...
    BS_328h_ESP_DSPL get_ESP_DSPL() { return (BS_328h_ESP_DSPL)(raw >> 24 & 0x1f); }
    ...
    bool get_NOTBRE() { return (bool)(raw >> 22 & 0x1); }
...
class ECU_ESP_SBC {
	public:
        ...
        /** Sets data in pointer to BS_200
          ...
          */
        bool get_BS_200(uint64_t now, uint64_t max_expire_time, BS_200* dest) {
        ...
        /** Sets data in pointer to BS_208
          ...
          * If the function returns true, then the pointer to 'dest' has been updated with the new CAN data
          */
        bool get_BS_208(uint64_t now, uint64_t max_expire_time, BS_208* dest) {
        ...
        /** Sets data in pointer to BS_270
          ...
          * If the function returns true, then the pointer to 'dest' has been updated with the new CAN data
          */
        bool get_BS_270(uint64_t now, uint64_t max_expire_time, BS_270* dest) {
        ...
        /** Sets data in pointer to BS_300
          ...
          * If the function returns true, then the pointer to 'dest' has been updated with the new CAN data
          */
        bool get_BS_300(uint64_t now, uint64_t max_expire_time, BS_300* dest) {
        ...
        /** Sets data in pointer to BS_328
          ...
          * If the function returns true, then the pointer to 'dest' has been updated with the new CAN data
          */
        bool get_BS_328(uint64_t now, uint64_t max_expire_time, BS_328* dest) {
