...
class ECU_ESP51 {
	public:
        ...
        /** Sets data in pointer to BS_200
          ...
          */
        bool get_BS_200(const uint32_t now, const uint32_t max_expire_time, BS_200_EGS51* dest) const {
            bool ret = false;
        ...
        /** Sets data in pointer to BS_208
          ...
          * If the function returns true, then the pointer to 'dest' has been updated with the new CAN data
          */
        bool get_BS_208(const uint32_t now, const uint32_t max_expire_time, BS_208_EGS51* dest) const {
            bool ret = false;
