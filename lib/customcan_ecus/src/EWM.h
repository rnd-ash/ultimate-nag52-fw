...
#define EWM_230_CUSTOMCAN_CAN_ID 0x0230

/** gear selector lever position (NAG only) */
enum class EWM_230h_WHC_CUSTOMCAN : uint16_t {
...
class ECU_EWM {
	public:
        ...
        /** Sets data in pointer to EWM_230
          ...
          */
        bool get_EWM_230(const uint32_t now, const uint32_t max_expire_time, EWM_230_CUSTOMCAN* dest) const {
            bool ret = false;
