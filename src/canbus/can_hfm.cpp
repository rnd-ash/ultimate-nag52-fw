...
WheelData HfmCan::get_front_right_wheel(const uint32_t expire_time_ms) {  // TODO
    return WheelData {
        .double_rpm = 0,
...
WheelData HfmCan::get_front_left_wheel(const uint32_t expire_time_ms) { // TODO
    return WheelData {
        .double_rpm = 0,
        .current_dir = WheelDirection::SignalNotAvailable
    };
...
bool HfmCan::get_engine_is_limp(const uint32_t expire_time_ms) { // TODO
    return false;
}
